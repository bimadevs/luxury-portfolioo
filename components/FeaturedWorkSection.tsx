            ...
            <div className="max-w-md">
              <p className="text-gray-400 mb-4">
                ...
                blend of innovation and technical expertise. */}
                 From source code to UI Library. It's an open source project that I built to help people
              </p>
              <Link
                href="#contact"
          ...
          {[
            {
              title: "BimsUI",
              number: "01",
              link: "https://ui.bimadev.xyz",
              description: "A free NextJs UI Component library website to help build modern websites",
              image:
                "/bimsui-preview.png",
            },
            {
              title: "BimSC",
              number: "02",
              link: "https://sc.bimadev.xyz",
              description: "A free and interesting source code collection website for everyone who wants to learn programming.",
              image:
                "/bimsc-preview.png",
            },
            // {
